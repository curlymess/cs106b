...
public:
    ...
    /**
     * Default board size of 5 to indicate 5x5 board.
     */
    static const int BOARD_SIZE_DEFAULT = 5;
...
private:
     ...
     */
    static const bool BIG_BOGGLE_SUPPORT = true;           // true to ask board size and allow Big Boggle
